...
//Generating random numbers
...

        {
            ...
            a = rand.nextInt(100);   //for first random number
            //System.out.println(a); not use
            b = rand.nextInt(100-a);  //2nd random number

            c = rand.nextInt(100-b);  //3rd random number

            d = rand.nextInt(100-c);  //4th random number

            e = rand.nextInt(100-d);   //5th random number

            sum = a + b+ c + d + e;   //the total number
